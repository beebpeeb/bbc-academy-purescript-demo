...
fromString = trim >>> case _ of
  "" -> None
  s -> maybe (Description s) Repeat $ stripSuffix (Pattern " e.") s
...
-- | Returns `true` if the given `Description` identifies a repeat transmission.
isRepeat :: Description -> Boolean
isRepeat = case _ of
  Repeat _ -> true
  _ -> false

-- | Returns the given `Description` as a plain `String`.
